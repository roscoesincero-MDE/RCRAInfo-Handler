...
/// no change tracking. Contact columns are absent because the procedure does not project them: they
/// are PII, and the grid is a list. <c>dbo.uspGetHandlerSourceDetail</c> is the only way to them.
/// </para>
/// <para>
...
/// </remarks>
[Keyless]
public sealed class HandlerSourceGridRow
{
