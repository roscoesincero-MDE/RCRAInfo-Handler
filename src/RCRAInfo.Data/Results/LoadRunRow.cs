...
/// no change tracking. <c>FailureMessage</c> is returned to a web page, so it must never carry the
/// API key or any credential; script 500's header records that it is displayed.
/// </para>
/// <para>
...
/// </remarks>
[Keyless]
public sealed class LoadRunRow
{
