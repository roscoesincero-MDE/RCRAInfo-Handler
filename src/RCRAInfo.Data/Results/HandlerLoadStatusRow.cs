...
/// no change tracking. <c>PayloadSha256</c> is the digest computed by <see
/// cref="PayloadJson.Sha256"/>; the two must agree in case and in encoding or every comparison
/// misses, which reads as "this handler changed" on every run.
/// </para>
/// <para>
...
/// </remarks>
[Keyless]
public sealed class HandlerLoadStatusRow
{
    public int HandlerLoadStatusId { get; init; }
    ...
    public DateTimeOffset FirstSeenDateUtc { get; init; }
    public DateTimeOffset? LastAttemptStartedDateUtc { get; init; }
    public DateTimeOffset? CompletedDateUtc { get; init; }
    public int? DurationMs { get; init; }
    public string EtsStatus { get; init; } = null!;
    public int EtsAttemptCount { get; init; }
    public string? EtsErrorMessage { get; init; }
    public DateTimeOffset? EtsLastAttemptDateUtc { get; init; }
    public DateTimeOffset? EtsMigratedDateUtc { get; init; }
    public long? ExecutionLogId { get; init; }
